...
<body>
<form role="form" action="/member/modMyInfo" method="post">
					...
					<div class="formContainer">
						<div class="panner-wrap">
							<div style="display: flex;">
								...
								<input type="text" class="main__input" id="userName" name="userId" readonly value="${memberVO.userId}"> 
							</div>
							<hr class="dividingLine">
							<div style="display: flex;">
								<img src="${contextPath}/resources/icon/login_icon.png" width="30px" height="30px"> 
								<input type="text" class="main__input" id="userName" name="userName" placeholder="변경할 이름을 입력해 주세요" maxlength="8" value="${memberVO.userName}">
							</div>
							<hr class="dividingLine">
							<div style="display: flex;">
								<img src="${contextPath}/resources/icon/password_icon.png" width="30px" height="30px"> 
								<input type="password" class="main__input" id="pw1" name="userPw" placeholder="변경할 비밀번호를 입력해 주세요" maxlength="20">
						...
						<div class="wrap__confirm">
							<button class="confirm__btn" id="signup__btn" type="submit" disabled="disabled">수정하기</button>
						</div>
					</div>
				</main>
	</div>
