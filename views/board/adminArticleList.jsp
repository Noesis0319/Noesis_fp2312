...
// 		alert("Form data: " + form.serialize());
	...
	$(".paginate_btn a").on("click", function(e){
		...
		let form=$('<form></form>');
		form.attr("method", "get");
		form.attr("action", "/board/adminBoard");
					...
					<c:otherwise>
						<c:forEach var="article" items="${articlesList}" varStatus="articleNum">
							...
							<tr>
								...
								<td>
								<a href="${pageContext.request.contextPath}/board/read?bno=${article.bno}&boardName=${article.boardName}"><c:out value="${article.title}" /></a>
